...
export class TradebinderCollectionCardController {
  constructor(
    private readonly tradebinderCollectionCardService: TradebinderCollectionCardService,
  ) {}
  ...
  create(
    ...
    return this.tradebinderCollectionCardService.create(
  ...
  update(
    ...
    return this.tradebinderCollectionCardService.update(
      +id,
      updateTradebinderCollectionCardDto,
    );
  }
